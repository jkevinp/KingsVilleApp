...
@section('content')
 <div class="row">
               ...
               <div class="input-field col s4 search-user--container">
                {!! Form::open(['route' => 'User.account.search' , 'method' => 'get']) !!}
    ...
    <i class="mdi-content-send right"></i>
                ...
                <div class="col s4 user--create-new right-align">
                    <a href="{{URL::route('User.account.create')}}" class="btn waves-effect waves-light blue darken-1" type="submit" name="action">Create New User
