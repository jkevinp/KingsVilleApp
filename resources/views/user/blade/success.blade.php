...
@section('content')
        <div class="row">
               <h5><i class="mdi-action-account-circle"></i> User Successfully Created</h5>
        </div>
        ...
        <div class="row center-align card">
           <div class="col s12 success-info">
            ...
            <a href="{{URL::route('User.index')}}" class="btn-large waves-effect waves-light go-back"><i class="mdi-navigation-arrow-back left"></i>Go back to User List</a>
        </div>
@stop